          ...
          >
            ...
            >
              ...
              <img
                ...
                className="relative h-12 sm:h-20 md:h-24 lg:h-24 w-auto object-contain filter drop-shadow-[0_0_25px_rgba(255,215,0,0.5)] 
                         scale-[1.2] sm:scale-[1.8] md:scale-[2.0] lg:scale-[2.0] hover:scale-[1.3] sm:hover:scale-[1.9] md:hover:scale-[2.1] lg:hover:scale-[2.1] 
